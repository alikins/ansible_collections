# Ansible module: ansible.module_bigiq_application_https_offload
...
``` json
{
    ...
    "service_environment": "{'description': ['Specifies the name of service environment or the hostname of the BIG-IP that the application will be deployed to.', 'When creating a new application, this parameter is required.']}",
