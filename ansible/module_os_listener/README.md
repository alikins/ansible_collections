# Ansible module: ansible.module_os_listener
...
``` json
{
    ...
    "loadbalancer": "{'description': ['The name or id of the load balancer that this listener belongs to.'], 'required': True}",
    "name": "{'description': ['Name that has to be given to the listener'], 'required': True}",
    "protocol": "{'description': ['The protocol for the listener.'], 'choices': ['HTTP', 'HTTPS', 'TCP', 'TERMINATED_HTTPS'], 'default': 'HTTP'}",
    "protocol_port": "{'description': ['The protocol port number for the listener.'], 'default': 80}",
