# Ansible module: ansible.module_os_user_group
...
``` json
{
    ...
    "group": "{'description': ['Name or id for the group.'], 'required': True}",
    ...
    "state": "{'description': ['Should the user be present or absent in the group'], 'choices': ['present', 'absent'], 'default': 'present'}",
    "timeout": "{'description': ['How long should ansible wait for the requested resource.'], 'required': False, 'default': 180}",
    "user": "{'description': ['Name or id for the user'], 'required': True}",
