# Ansible module: ansible.module_nxos_aaa_server_host
...
``` json
{
    "acct_port": "{'description': ["Alternate UDP port for RADIUS accounting or keyword 'default'."]}",
    "address": "{'description': ['Address or name of the radius or tacacs host.'], 'required': True}",
    "auth_port": "{'description': ["Alternate UDP port for RADIUS authentication or keyword 'default'."]}",
    "encrypt_type": "{'description': ['The state of encryption applied to the entered key. O for clear text, 7 for encrypted. Type-6 encryption is not supported.'], 'choices': ['0', '7']}",
    "host_timeout": "{'description': ["Timeout period for specified host, in seconds or keyword 'default. Range is 1-60."]}",
    "key": "{'description': ["Shared secret for the specified host or keyword 'default'."]}",
    ...
    "tacacs_port": "{'description': ["Alternate TCP port TACACS Server or keyword 'default'."]}",
}
```
