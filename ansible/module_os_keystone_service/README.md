# Ansible module: ansible.module_os_keystone_service
...
``` json
{
    ...
    "enabled": "{'description': ['Is the service enabled'], 'type': 'bool', 'default': True}",
    ...
    "service_type": "{'description': ['The type of service'], 'required': True}",
