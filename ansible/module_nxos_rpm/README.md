# Ansible module: ansible.module_nxos_rpm
...
``` json
{
    "aggregate": "{'description': ['List of RPM/patch definitions.']}",
    "file_system": "{'description': ['The remote file system of the device. If omitted, devices that support a file_system parameter will use their default values.'], 'default': 'bootflash'}",
    "pkg": "{'description': ['Name of the RPM package.'], 'required': True}",
    ...
    "state": "{'description': ['If the state is present, the rpm will be installed, If the state is absent, it will be removed.'], 'default': 'present', 'choices': ['present', 'absent']}",
}
```
