# Ansible module: ansible.module_ovirt_datacenter_facts
...
``` json
{
    ...
    "pattern": "{'description': ['Search term which is accepted by oVirt/RHV search backend.', 'For example to search datacenter I(X) use following pattern: I(name=X)']}",
}
```
