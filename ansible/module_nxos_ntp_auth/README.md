# Ansible module: ansible.module_nxos_ntp_auth
...
``` json
{
    "auth_type": "{'description': ['Whether the given md5string is in cleartext or has been encrypted. If in cleartext, the device will encrypt it before storing it.'], 'default': 'text', 'choices': ['text', 'encrypt']}",
    "authentication": "{'description': ['Turns NTP authentication on or off.'], 'choices': ['on', 'off']}",
    "key_id": "{'description': ['Authentication key identifier (numeric).']}",
    "md5string": "{'description': ['MD5 String.']}",
    ...
    "trusted_key": "{'description': ['Whether the given key is required to be supplied by a time source for the device to synchronize to the time source.'], 'choices': ['false', 'true'], 'default': 'false'}",
}
```
