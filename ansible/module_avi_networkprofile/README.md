# Ansible module: ansible.module_avi_networkprofile
...
``` json
{
    ...
    "name": "{'description': ['The name of the network profile.'], 'required': True}",
    ...
    "profile": "{'description': ['Networkprofileunion settings for networkprofile.'], 'required': True}",
    ...
    "uuid": "{'description': ['Uuid of the network profile.']}",
}
```
