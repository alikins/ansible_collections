# Ansible module: ansible.module_nxos_gir_profile_management
...
``` json
{
    "commands": "{'description': ['List of commands to be included into the profile.']}",
    "mode": "{'description': ['Configure the profile as Maintenance or Normal mode.'], 'required': True, 'choices': ['maintenance', 'normal']}",
