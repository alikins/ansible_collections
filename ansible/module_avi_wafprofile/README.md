# Ansible module: ansible.module_avi_wafprofile
...
``` json
{
    ...
    "config": "{'description': ['Config params for waf.', 'Field introduced in 17.2.1.'], 'required': True}",
    ...
    "files": "{'description': ['List of data files used for waf rules.', 'Field introduced in 17.2.1.']}",
