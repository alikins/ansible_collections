# Ansible module: ansible.module_ovirt_affinity_label_facts
...
``` json
{
    ...
    "host": "{'description': ['Name of the host, which affinity labels should be listed.']}",
    "name": "{'description': ['Name of the affinity labels which should be listed.']}",
    ...
    "vm": "{'description': ['Name of the VM, which affinity labels should be listed.']}",
}
```
