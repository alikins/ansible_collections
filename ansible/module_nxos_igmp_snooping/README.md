# Ansible module: ansible.module_nxos_igmp_snooping
...
``` json
{
    "group_timeout": "{'description': ['Group membership timeout value for all VLANs on the device. Accepted values are integer in range 1-10080, I(never) and I(default).']}",
    "link_local_grp_supp": "{'description': ['Global link-local groups suppression.'], 'type': 'bool'}",
    ...
    "report_supp": "{'description': ['Global IGMPv1/IGMPv2 Report Suppression.'], 'type': 'bool'}",
    "snooping": "{'description': ['Enables/disables IGMP snooping on the switch.'], 'type': 'bool'}",
    "state": "{'description': ['Manage the state of the resource.'], 'default': 'present', 'choices': ['present', 'default']}",
    "v3_report_supp": "{'description': ['Global IGMPv3 Report Suppression and Proxy Reporting.'], 'type': 'bool'}",
}
```
