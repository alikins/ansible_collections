# Ansible module: ansible.module_avi_alertsyslogconfig
...
``` json
{
    ...
    "description": "{'description': ['User defined description for alert syslog config.']}",
    "name": "{'description': ['A user-friendly name of the syslog notification.'], 'required': True}",
    ...
    "syslog_servers": "{'description': ['The list of syslog servers.']}",
