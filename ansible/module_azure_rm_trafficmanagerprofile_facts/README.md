# Ansible module: ansible.module_azure_rm_trafficmanagerprofile_facts
...
``` json
{
    ...
    "name": "{'description': ['Limit results to a specific Traffic Manager profile.']}",
    ...
    "resource_group": "{'description': ['The resource group to search for the desired Traffic Manager profile']}",
