# Ansible module: ansible.module_gcp_container_node_pool
...
``` json
{
    ...
    "zone": "{'description': ['The zone where the node pool is deployed.'], 'required': True}",
}
```
