# Ansible module: ansible.module_nxos_snmp_traps
...
``` json
{
    "group": "{'description': ['Case sensitive group.'], 'required': True, 'choices': ['aaa', 'bfd', 'bgp', 'bridge', 'callhome', 'cfs', 'config', 'eigrp', 'entity', 'feature-control', 'generic', 'hsrp', 'license', 'link', 'lldp', 'mmode', 'ospf', 'pim', 'rf', 'rmon', 'snmp', 'storm-control', 'stpx', 'switchfabric', 'syslog', 'sysmgr', 'system', 'upgrade', 'vtp', 'all']}",
    ...
    "state": "{'description': ['Manage the state of the resource.'], 'required': False, 'default': 'enabled', 'choices': ['enabled', 'disabled']}",
}
```
