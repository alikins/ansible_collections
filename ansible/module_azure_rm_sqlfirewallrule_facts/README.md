# Ansible module: ansible.module_azure_rm_sqlfirewallrule_facts
...
``` json
{
    ...
    "name": "{'description': ['The name of the firewall rule.']}",
    ...
    "resource_group": "{'description': ['The name of the resource group that contains the server.'], 'required': True}",
