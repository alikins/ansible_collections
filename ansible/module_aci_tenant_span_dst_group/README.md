# Ansible module: ansible.module_aci_tenant_span_dst_group
...
``` json
{
    ...
    "description": "{'description': ['The description of the SPAN destination group.'], 'aliases': ['descr']}",
    "dst_group": "{'description': ['The name of the SPAN destination group.'], 'required': True, 'aliases': ['name']}",
