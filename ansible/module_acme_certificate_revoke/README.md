# Ansible module: ansible.module_acme_certificate_revoke
...
``` json
{
    ...
    "certificate": "{'description': ['Path to the certificate to revoke.'], 'required': True}",
    ...
    "private_key_src": "{'description': ["Path to the certificate's private key.", 'Note that exactly one of C(account_key_src), C(account_key_content), C(private_key_src) or C(private_key_content) must be specified.']}",
    "revoke_reason": "{'description': ['One of the revocation reasonCodes defined in L(https://tools.ietf.org/html/rfc5280#section-5.3.1, Section 5.3.1 of RFC5280).', 'Possible values are C(0) (unspecified), C(1) (keyCompromise), C(2) (cACompromise), C(3) (affiliationChanged), C(4) (superseded), C(5) (cessationOfOperation), C(6) (certificateHold), C(8) (removeFromCRL), C(9) (privilegeWithdrawn), C(10) (aACompromise)']}",
