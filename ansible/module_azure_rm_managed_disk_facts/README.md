# Ansible module: ansible.module_azure_rm_managed_disk_facts
...
``` json
{
    ...
    "name": "{'description': ['Limit results to a specific managed disk']}",
    ...
    "resource_group": "{'description': ['Limit results to a specific resource group']}",
