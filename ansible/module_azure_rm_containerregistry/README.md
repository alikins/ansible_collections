# Ansible module: ansible.module_azure_rm_containerregistry
...
``` json
{
    ...
    "admin_user_enabled": "{'description': ['If enabled, you can use the registry name as username and admin user access key as password to docker login to your container registry.'], 'type': 'bool', 'default': False}",
    ...
    "name": "{'description': ['Name of the Container Registry.'], 'required': True}",
    ...
    "resource_group": "{'description': ['Name of a resource group where the Container Registry exists or will be created.'], 'required': True}",
    "secret": "{'description': ['Azure client secret. Use when authenticating with a Service Principal.']}",
    "sku": "{'description': ['Specifies the SKU to use. Currently can be either Basic, Standard or Premium.'], 'default': 'Standard', 'choices': ['Basic', 'Standard', 'Premium']}",
    "state": "{'description': ["Assert the state of the container registry. Use 'present' to create or update an container registry and 'absent' to delete it."], 'default': 'present', 'choices': ['absent', 'present']}",
