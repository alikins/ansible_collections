# Ansible module: ansible.module_nxos_linkagg


Manage link aggregation groups on Cisco NXOS devices
...
``` json
{
    ...
    "force": "{'description': ['When true it forces link aggregation group members to match what is declared in the members param. This can be used to remove members.'], 'type': 'bool', 'default': False}",
    "group": "{'description': ['Channel-group number for the port-channel Link aggregation group.'], 'required': True}",
    "members": "{'description': ['List of interfaces that will be managed in the link aggregation group.']}",
    "min_links": "{'description': ['Minimum number of ports required up before bringing up the link aggregation group.']}",
    "mode": "{'description': ['Mode for the link aggregation group.'], 'choices': ['active', 'on', 'passive'], 'default': 'on'}",
    ...
    "purge": "{'description': ['Purge links not defined in the I(aggregate) parameter.'], 'type': 'bool', 'default': False}",
