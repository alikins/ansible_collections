# Ansible module: ansible.module_azure_rm_keyvaultsecret
...
``` json
{
    ...
    "secret_name": "{'description': ['Name of the keyvault secret.'], 'required': True}",
    "secret_value": "{'description': ['Secret to be secured by keyvault.']}",
    "state": "{'description': ["Assert the state of the subnet. Use 'present' to create or update a secret and 'absent' to delete a secret ."], 'default': 'present', 'choices': ['absent', 'present']}",
