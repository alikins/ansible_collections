# Ansible module: ansible.module_azure_rm_cdnprofile_facts
...
``` json
{
    ...
    "name": "{'description': ['Limit results to a specific CDN profile.']}",
    ...
    "resource_group": "{'description': ['The resource group to search for the desired CDN profile']}",
