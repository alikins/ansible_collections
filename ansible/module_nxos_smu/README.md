# Ansible module: ansible.module_nxos_smu
...
``` json
{
    "file_system": "{'description': ['The remote file system of the device. If omitted, devices that support a file_system parameter will use their default values.']}",
    "pkg": "{'description': ['Name of the remote package.'], 'required': True}",
