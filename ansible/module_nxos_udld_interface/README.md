# Ansible module: ansible.module_nxos_udld_interface
...
``` json
{
    "interface": "{'description': ['FULL name of the interface, i.e. Ethernet1/1-'], 'required': True}",
    "mode": "{'description': ['Manages UDLD mode for an interface.'], 'required': True, 'choices': ['enabled', 'disabled', 'aggressive']}",
    ...
    "state": "{'description': ['Manage the state of the resource.'], 'required': False, 'default': 'present', 'choices': ['present', 'absent']}",
}
```
