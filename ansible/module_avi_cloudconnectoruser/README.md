# Ansible module: ansible.module_avi_cloudconnectoruser
...
``` json
{
    ...
    "azure_serviceprincipal": "{'description': ['Field introduced in 17.2.1.'], 'version_added': '2.5'}",
    "azure_userpass": "{'description': ['Field introduced in 17.2.1.'], 'version_added': '2.5'}",
    ...
    "private_key": "{'description': ['Private_key of cloudconnectoruser.']}",
    "public_key": "{'description': ['Public_key of cloudconnectoruser.']}",
