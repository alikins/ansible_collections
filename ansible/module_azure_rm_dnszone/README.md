# Ansible module: ansible.module_azure_rm_dnszone
...
``` json
{
    ...
    "name": "{'description': ['name of the DNS Zone.'], 'required': True}",
    ...
    "state": "{'description': ["Assert the state of the zone. Use 'present' to create or update and 'absent' to delete."], 'default': 'present', 'choices': ['absent', 'present']}",
