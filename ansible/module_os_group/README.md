# Ansible module: ansible.module_os_group
...
``` json
{
    ...
    "domain_id": "{'description': ['Domain id to create the group in if the cloud supports domains.'], 'version_added': '2.3'}",
    ...
    "name": "{'description': ['Group name'], 'required': True}",
