# Ansible module: ansible.module_azure_rm_webapp_facts
...
``` json
{
    ...
    "name": "{'description': ['Only show results for a specific web app.']}",
    ...
    "return_publish_profile": "{'description': ['Indicate wheather to return publishing profile of the web app.'], 'default': False, 'type': 'bool'}",
