# Ansible module: ansible.module_nxos_ping
...
``` json
{
    ...
    "dest": "{'description': ['IP address or hostname (resolvable by switch) of remote node.'], 'required': True}",
