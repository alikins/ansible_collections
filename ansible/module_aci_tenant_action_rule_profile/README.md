# Ansible module: ansible.module_aci_tenant_action_rule_profile
...
``` json
{
    "action_rule": "{'description': ['The name of the action rule profile.'], 'aliases': ['action_rule_name', 'name']}",
    ...
    "description": "{'description': ['The description for the action rule profile.'], 'aliases': ['descr']}",
