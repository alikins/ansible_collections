# Ansible module: ansible.module_azure_rm_image_facts
...
``` json
{
    ...
    "name": "{'description': ['Name of the image to filter from existing images.']}",
    ...
    "resource_group": "{'description': ['Name of resource group.']}",
