# Ansible module: ansible.module_ovirt_scheduling_policy_facts
...
``` json
{
    ...
    "id": "{'description': ['ID of the scheduling policy.'], 'required': True}",
    "name": "{'description': ['Name of the scheduling policy, can be used as glob expression.']}",
