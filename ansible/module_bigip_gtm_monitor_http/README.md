# Ansible module: ansible.module_bigip_gtm_monitor_http
...
``` json
{
    ...
    "parent": "{'description': ['The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the C(tcp) parent on the C(Common) partition.'], 'default': '/Common/http'}",
