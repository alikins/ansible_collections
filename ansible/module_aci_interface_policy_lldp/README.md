# Ansible module: ansible.module_aci_interface_policy_lldp
...
``` json
{
    ...
    "description": "{'description': ['The description for the LLDP interface policy name.'], 'aliases': ['descr']}",
    "host": "{'description': ['IP Address or hostname of APIC resolvable by Ansible control host.'], 'required': True, 'aliases': ['hostname']}",
    "lldp_policy": "{'description': ['The LLDP interface policy name.'], 'required': True, 'aliases': ['name']}",
    ...
    "receive_state": "{'description': ['Enable or disable Receive state.', 'The APIC defaults to C(yes) when unset during creation.'], 'type': 'bool'}",
    ...
    "transmit_state": "{'description': ['Enable or Disable Transmit state.', 'The APIC defaults to C(yes) when unset during creation.'], 'type': 'bool'}",
