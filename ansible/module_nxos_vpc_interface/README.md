# Ansible module: ansible.module_nxos_vpc_interface
...
``` json
{
    "peer_link": "{'description': ['Set to true/false for peer link config on associated portchannel.']}",
    "portchannel": "{'description': ['Group number of the portchannel that will be configured.'], 'required': True}",
    ...
    "state": "{'description': ['Manages desired state of the resource.'], 'required': True, 'choices': ['present', 'absent'], 'default': 'present'}",
    "vpc": "{'description': ['VPC group/id that will be configured on associated portchannel.']}",
}
```
