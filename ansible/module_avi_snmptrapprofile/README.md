# Ansible module: ansible.module_avi_snmptrapprofile
...
``` json
{
    ...
    "name": "{'description': ['A user-friendly name of the snmp trap configuration.'], 'required': True}",
    ...
    "trap_servers": "{'description': ['The ip address or hostname of the snmp trap destination server.']}",
    ...
    "uuid": "{'description': ['Uuid of the snmp trap profile object.']}",
}
```
