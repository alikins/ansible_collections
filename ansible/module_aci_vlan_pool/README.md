# Ansible module: ansible.module_aci_vlan_pool
...
``` json
{
    ...
    "pool_allocation_mode": "{'description': ['The method used for allocating VLANs to resources.'], 'aliases': ['allocation_mode', 'mode'], 'choices': ['dynamic', 'static']}",
