# Ansible module: ansible.module_nxos_snmp_community
...
``` json
{
    "access": "{'description': ['Access type for community.'], 'choices': ['ro', 'rw']}",
    "acl": "{'description': ["ACL name to filter snmp requests or keyword 'default'."]}",
    "community": "{'description': ['Case-sensitive community string.'], 'required': True}",
    "group": "{'description': ['Group to which the community belongs.']}",
