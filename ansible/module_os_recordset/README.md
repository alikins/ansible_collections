# Ansible module: ansible.module_os_recordset
...
``` json
{
    ...
    "description": "{'description': ['Description of the recordset']}",
    ...
    "name": "{'description': ['Name of the recordset'], 'required': True}",
    "records": "{'description': ['List of recordset definitions'], 'required': True}",
    "recordset_type": "{'description': ['Recordset type'], 'required': True}",
    ...
    "zone": "{'description': ['Zone managing the recordset'], 'required': True}",
}
```
