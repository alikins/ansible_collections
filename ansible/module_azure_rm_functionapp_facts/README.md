# Ansible module: ansible.module_azure_rm_functionapp_facts
...
``` json
{
    ...
    "name": "{'description': ['Only show results for a specific Function App']}",
    ...
    "resource_group": "{'description': ['Limit results to a resource group. Required when filtering by name'], 'aliases': ['resource_group_name']}",
