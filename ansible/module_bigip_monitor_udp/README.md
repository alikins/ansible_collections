# Ansible module: ansible.module_bigip_monitor_udp
...
``` json
{
    ...
    "parent": "{'description': ['The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the C(udp) parent on the C(Common) partition.'], 'default': '/Common/udp'}",
    ...
    "send": "{'description': ['The send string for the monitor call. When creating a new monitor, if this value is not provided, the default C(default send string) will be used.']}",
