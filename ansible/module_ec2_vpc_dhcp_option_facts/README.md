# Ansible module: ansible.module_ec2_vpc_dhcp_option_facts
...
``` json
{
    ...
    "dhcp_options_ids": "{'description': ['Get details of specific DHCP Option ID', 'Provide this value as a list'], 'aliases': ['DhcpOptionIds']}",
