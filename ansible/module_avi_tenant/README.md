# Ansible module: ansible.module_avi_tenant
...
``` json
{
    ...
    "config_settings": "{'description': ['Tenantconfiguration settings for tenant.']}",
    ...
    "created_by": "{'description': ['Creator of this tenant.']}",
    "description": "{'description': ['User defined description for the object.']}",
    "local": "{'description': ['Boolean flag to set local.', 'Default value when not specified in API or module is interpreted by Avi Controller as True.'], 'type': 'bool'}",
