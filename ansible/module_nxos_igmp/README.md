# Ansible module: ansible.module_nxos_igmp
...
``` json
{
    "enforce_rtr_alert": "{'description': ['Enables or disables the enforce router alert option check for IGMPv2 and IGMPv3 packets.'], 'type': 'bool'}",
    "flush_routes": "{'description': ['Removes routes when the IGMP process is restarted. By default, routes are not flushed.'], 'type': 'bool'}",
    ...
    "restart": "{'description': ['Restarts the igmp process (using an exec config command).'], 'type': 'bool'}",
