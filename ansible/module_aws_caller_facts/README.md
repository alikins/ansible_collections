# Ansible module: ansible.module_aws_caller_facts


Get facts about the user and account being used to make AWS calls
...
## Author Information
  - ['Ed Costello (@orthanc)', 'Stijn Dubrul (@sdubrul)']
  - ['Ed Costello (@orthanc)', 'Stijn Dubrul (@sdubrul)']
