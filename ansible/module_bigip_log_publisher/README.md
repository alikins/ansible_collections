# Ansible module: ansible.module_bigip_log_publisher
...
``` json
{
    "description": "{'description': ['Specifies a description for the log publisher.']}",
    "destinations": "{'description': ['Specifies log destinations for this log publisher to use.']}",
    "name": "{'description': ['Specifies the name of the log publisher.'], 'required': True}",
