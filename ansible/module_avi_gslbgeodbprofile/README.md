# Ansible module: ansible.module_avi_gslbgeodbprofile
...
``` json
{
    ...
    "entries": "{'description': ['List of geodb entries.', 'An entry can either be a geodb file or an ip address group with geo properties.', 'Field introduced in 17.1.1.']}",
    ...
    "name": "{'description': ['A user-friendly name for the geodb profile.', 'Field introduced in 17.1.1.'], 'required': True}",
    ...
    "uuid": "{'description': ['Uuid of the geodb profile.', 'Field introduced in 17.1.1.']}",
}
```
