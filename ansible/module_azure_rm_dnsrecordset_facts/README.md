# Ansible module: ansible.module_azure_rm_dnsrecordset_facts
...
``` json
{
    ...
    "record_type": "{'description': ['Limit record sets by record type.']}",
    "relative_name": "{'description': ['Only show results for a Record Set.']}",
    "resource_group": "{'description': ['Limit results by resource group. Required when filtering by name or type.']}",
    ...
    "top": "{'description': ['Limit the maximum number of record sets to return'], 'default': 100}",
    "zone_name": "{'description': ['Limit results by zones. Required when filtering by name or type.']}",
}
```
