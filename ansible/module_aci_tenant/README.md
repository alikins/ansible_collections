# Ansible module: ansible.module_aci_tenant
...
``` json
{
    ...
    "description": "{'description': ['Description for the tenant.'], 'aliases': ['descr']}",
    ...
    "tenant": "{'description': ['The name of the tenant.'], 'required': True, 'aliases': ['name', 'tenant_name']}",
