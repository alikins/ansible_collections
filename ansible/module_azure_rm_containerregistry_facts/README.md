# Ansible module: ansible.module_azure_rm_containerregistry_facts
...
``` json
{
    ...
    "name": "{'description': ['The name of the container registry.']}",
    ...
    "resource_group": "{'description': ['The name of the resource group to which the container registry belongs.'], 'required': True}",
    "retrieve_credentials": "{'description': ['Retrieve credentials for container registry.'], 'type': 'bool', 'default': False}",
