# Ansible module: ansible.module_avi_backup
...
``` json
{
    ...
    "backup_config_ref": "{'description': ['Backupconfiguration information.', 'It is a reference to an object of type backupconfiguration.']}",
    ...
    "file_name": "{'description': ['The file name of backup.'], 'required': True}",
    "local_file_url": "{'description': ['Url to download the backup file.']}",
    ...
    "remote_file_url": "{'description': ['Url to download the backup file.']}",
    "scheduler_ref": "{'description': ['Scheduler information.', 'It is a reference to an object of type scheduler.']}",
    ...
    "timestamp": "{'description': ['Unix timestamp of when the backup file is created.']}",
