# Ansible module: ansible.module_nxos_feature
...
``` json
{
    "feature": "{'description': ['Name of feature.'], 'required': True}",
    ...
    "state": "{'description': ['Desired state of the feature.'], 'required': False, 'default': 'enabled', 'choices': ['enabled', 'disabled']}",
}
```
