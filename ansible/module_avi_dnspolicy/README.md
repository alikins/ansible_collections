# Ansible module: ansible.module_avi_dnspolicy
...
``` json
{
    ...
    "created_by": "{'description': ['Creator name.', 'Field introduced in 17.1.1.']}",
    "description": "{'description': ['Field introduced in 17.1.1.']}",
    "name": "{'description': ['Name of the dns policy.', 'Field introduced in 17.1.1.'], 'required': True}",
    ...
    "rule": "{'description': ['Dns rules.', 'Field introduced in 17.1.1.']}",
    ...
    "uuid": "{'description': ['Uuid of the dns policy.', 'Field introduced in 17.1.1.']}",
}
```
