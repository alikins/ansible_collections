# Ansible module: ansible.module_azure_rm_postgresqlserver
...
``` json
{
    ...
    "state": "{'description': ["Assert the state of the PostgreSQL server. Use 'present' to create or update a server and 'absent' to delete it."], 'default': 'present', 'choices': ['present', 'absent']}",
    ...
    "version": "{'description': ['Server version.'], 'choices': ['9.5', '9.6']}",
}
```
