# Ansible module: ansible.module_aci_interface_policy_fc
...
``` json
{
    ...
    "description": "{'description': ['The description of the Fiber Channel interface policy.'], 'aliases': ['descr']}",
    "fc_policy": "{'description': ['The name of the Fiber Channel interface policy.'], 'required': True, 'aliases': ['name']}",
    ...
    "port_mode": "{'description': ['The Port Mode to use.', 'The APIC defaults to C(f) when unset during creation.'], 'choices': ['f', 'np']}",
