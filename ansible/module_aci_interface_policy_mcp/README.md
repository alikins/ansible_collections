# Ansible module: ansible.module_aci_interface_policy_mcp
...
``` json
{
    "admin_state": "{'description': ['Enable or disable admin state.', 'The APIC defaults to C(yes) when unset during creation.'], 'type': 'bool'}",
    ...
    "description": "{'description': ['The description for the MCP interface.'], 'aliases': ['descr']}",
    "host": "{'description': ['IP Address or hostname of APIC resolvable by Ansible control host.'], 'required': True, 'aliases': ['hostname']}",
    "mcp": "{'description': ['The name of the MCP interface.'], 'required': True, 'aliases': ['mcp_interface', 'name']}",
