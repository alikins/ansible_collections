# Ansible module: ansible.module_azure_rm_aks_facts
...
``` json
{
    ...
    "name": "{'description': ['Limit results to a specific resource group.']}",
    ...
    "resource_group": "{'description': ['The resource group to search for the desired Azure Kubernetes Service']}",
