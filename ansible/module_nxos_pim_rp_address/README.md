# Ansible module: ansible.module_nxos_pim_rp_address
...
``` json
{
    "bidir": "{'description': ['Group range is treated in PIM bidirectional mode.'], 'type': 'bool'}",
    "group_list": "{'description': ['Group range for static RP. Valid values are multicast addresses.']}",
    "prefix_list": "{'description': ['Prefix list policy for static RP. Valid values are prefix-list policy names.']}",
    ...
    "route_map": "{'description': ['Route map policy for static RP. Valid values are route-map policy names.']}",
    "rp_address": "{'description': ['Configures a Protocol Independent Multicast (PIM) static rendezvous point (RP) address. Valid values are unicast addresses.'], 'required': True}",
    "state": "{'description': ['Specify desired state of the resource.'], 'required': True, 'default': 'present', 'choices': ['present', 'absent', 'default']}",
}
```
