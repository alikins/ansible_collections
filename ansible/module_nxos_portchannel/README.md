# Ansible module: ansible.module_nxos_portchannel
...
``` json
{
    "force": "{'description': ['When true it forces port-channel members to match what is declared in the members param. This can be used to remove members.'], 'choices': ['false', 'true'], 'default': 'false'}",
    "group": "{'description': ['Channel-group number for the port-channel.'], 'required': True}",
    "members": "{'description': ['List of interfaces that will be managed in a given portchannel.']}",
    "min_links": "{'description': ['Min links required to keep portchannel up.']}",
    "mode": "{'description': ['Mode for the port-channel, i.e. on, active, passive.'], 'default': True, 'choices': ['active', 'passive', 'on']}",
