# Ansible module: ansible.module_azure_rm_virtualmachine_facts
...
``` json
{
    ...
    "name": "{'description': ['Name of the virtual machine.']}",
    ...
    "resource_group": "{'description': ['Name of the resource group containing the virtual machines (required when filtering by vm name).']}",
...
## Author Information
  - ['Gustavo Muniz do Carmo (@gustavomcarmo)', 'Zim Kalinowski (@zikalino)']
  - ['Gustavo Muniz do Carmo (@gustavomcarmo)', 'Zim Kalinowski (@zikalino)']
