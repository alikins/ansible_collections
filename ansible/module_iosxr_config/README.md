# Ansible module: ansible.module_iosxr_config
...
``` json
{
    "admin": "{'description': ['Enters into administration configuration mode for making config changes to the device.'], 'type': 'bool', 'default': False, 'version_added': '2.4'}",
    ...
    "comment": "{'description': ['Allows a commit description to be specified to be included when the configuration is committed.  If the configuration is not changed or committed, this argument is ignored.'], 'default': 'configured by iosxr_config', 'version_added': '2.2'}",
