# Ansible module: ansible.module_nxos_rollback
...
``` json
{
    "checkpoint_file": "{'description': ['Name of checkpoint file to create. Mutually exclusive with rollback_to.']}",
    ...
    "rollback_to": "{'description': ['Name of checkpoint file to rollback to. Mutually exclusive with checkpoint_file.']}",
}
```
