# Ansible module: ansible.module_avi_networksecuritypolicy
...
``` json
{
    ...
    "cloud_config_cksum": "{'description': ['Checksum of cloud configuration for network sec policy.', 'Internally set by cloud connector.']}",
    ...
    "rules": "{'description': ['List of networksecurityrule.']}",
