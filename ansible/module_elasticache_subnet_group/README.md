# Ansible module: ansible.module_elasticache_subnet_group
...
``` json
{
    ...
    "description": "{'description': ['Elasticache subnet group description. Only set when a new group is added.']}",
    ...
    "subnets": "{'description': ['List of subnet IDs that make up the Elasticache subnet group.']}",
