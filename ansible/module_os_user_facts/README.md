# Ansible module: ansible.module_os_user_facts


Retrieve facts about one or more OpenStack users
...
``` json
{
    ...
    "domain": "{'description': ['Name or ID of the domain containing the user if the cloud supports domains']}",
    ...
    "name": "{'description': ['Name or ID of the user'], 'required': True}",
