# Ansible module: ansible.module_nxos_banner
...
``` json
{
    "banner": "{'description': ['Specifies which banner that should be configured on the remote device.'], 'required': True, 'choices': ['exec', 'motd']}",
