# Ansible module: ansible.module_cnos_config
...
``` json
{
    ...
    "comment": "{'description': ['Allows a commit description to be specified to be included when the configuration is committed.  If the configuration is not changed or committed, this argument is ignored.'], 'default': 'configured by cnos_config'}",
