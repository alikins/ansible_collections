# Ansible module: ansible.module_avi_alertscriptconfig
...
``` json
{
    "action_script": "{'description': ['User defined alert action script.', 'Please refer to kb.avinetworks.com for more information.']}",
    ...
    "name": "{'description': ['A user-friendly name of the script.'], 'required': True}",
