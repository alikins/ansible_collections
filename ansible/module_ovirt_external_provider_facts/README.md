# Ansible module: ansible.module_ovirt_external_provider_facts
...
``` json
{
    ...
    "name": "{'description': ['Name of the external provider, can be used as glob expression.']}",
    ...
    "type": "{'description': ['Type of the external provider.'], 'choices': ['os_image', 'os_network', 'os_volume', 'foreman'], 'required': True}",
}
```
