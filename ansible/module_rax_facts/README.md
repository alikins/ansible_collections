# Ansible module: ansible.module_rax_facts
...
``` json
{
    "address": "{'description': ['Server IP address to retrieve facts for, will match any IP assigned to the server']}",
    ...
    "id": "{'description': ['Server ID to retrieve facts for']}",
    ...
    "name": "{'description': ['Server name to retrieve facts for']}",
