# Ansible module: ansible.module_ovirt_quota_facts
...
``` json
{
    ...
    "data_center": "{'description': ['Name of the datacenter where quota resides.'], 'required': True}",
    ...
    "name": "{'description': ['Name of the quota, can be used as glob expression.']}",
