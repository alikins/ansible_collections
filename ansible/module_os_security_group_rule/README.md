# Ansible module: ansible.module_os_security_group_rule
...
``` json
{
    ...
    "direction": "{'description': ['The direction in which the security group rule is applied. Not all providers support egress.'], 'choices': ['egress', 'ingress'], 'default': 'ingress'}",
    "ethertype": "{'description': ['Must be IPv4 or IPv6, and addresses represented in CIDR must match the ingress or egress rules. Not all providers support IPv6.'], 'choices': ['IPv4', 'IPv6'], 'default': 'IPv4'}",
    ...
    "port_range_min": "{'description': ['Starting port']}",
    "project": "{'description': ['Unique name or ID of the project.'], 'required': False, 'version_added': '2.7'}",
    "protocol": "{'description': ['IP protocols TCP UDP ICMP 112 (VRRP)'], 'choices': ['tcp', 'udp', 'icmp', '112', 'None']}",
    "region_name": "{'description': ['Name of the region.'], 'required': False}",
    "remote_group": "{'description': ['Name or ID of the Security group to link (exclusive with remote_ip_prefix)']}",
    "remote_ip_prefix": "{'description': ['Source IP address(es) in CIDR notation (exclusive with remote_group)']}",
    "security_group": "{'description': ['Name or ID of the security group'], 'required': True}",
