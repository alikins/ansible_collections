# Ansible module: ansible.module_ovirt_vmpool_facts
...
``` json
{
    ...
    "pattern": "{'description': ['Search term which is accepted by oVirt/RHV search backend.', 'For example to search vmpool X: name=X']}",
}
```
