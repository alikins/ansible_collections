# Ansible module: ansible.module_os_project
...
``` json
{
    ...
    "description": "{'description': ['Description for the project']}",
    "domain_id": "{'description': ['Domain id to create the project in if the cloud supports domains.'], 'aliases': ['domain']}",
    "enabled": "{'description': ['Is the project enabled'], 'type': 'bool', 'default': True}",
    ...
    "name": "{'description': ['Name for the project'], 'required': True}",
