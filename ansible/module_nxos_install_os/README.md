# Ansible module: ansible.module_nxos_install_os
...
``` json
{
    ...
    "system_image_file": "{'description': ['Name of the system (or combined) image file on flash.'], 'required': True}",
}
```
...
## Author Information
  - ['Jason Edelman (@jedelman8)', 'Gabriele Gerbibo (@GGabriele)']
  - ['Jason Edelman (@jedelman8)', 'Gabriele Gerbibo (@GGabriele)']
