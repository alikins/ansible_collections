# Ansible module: ansible.module_azure_rm_routetable_facts
...
``` json
{
    ...
    "name": "{'description': ['Limit results to a specific route table.']}",
    ...
    "resource_group": "{'description': ['Limit results in a specific resource group.']}",
