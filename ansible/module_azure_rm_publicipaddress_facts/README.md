# Ansible module: ansible.module_azure_rm_publicipaddress_facts
...
``` json
{
    ...
    "name": "{'description': ['Only show results for a specific Public IP.']}",
    ...
    "resource_group": "{'description': ['Limit results by resource group. Required when using name parameter.']}",
