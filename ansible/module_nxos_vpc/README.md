# Ansible module: ansible.module_nxos_vpc
...
``` json
{
    "auto_recovery": "{'description': ['Enables/Disables auto recovery'], 'type': 'bool'}",
    "delay_restore": "{'description': ['manages delay restore command and config value in seconds'], 'type': 'bool'}",
    "domain": "{'description': ['VPC domain'], 'required': True}",
    "peer_gw": "{'description': ['Enables/Disables peer gateway'], 'type': 'bool'}",
    "pkl_dest": "{'description': ['Destination (remote) IP address used for peer keepalive link']}",
    "pkl_src": "{'description': ['Source IP address used for peer keepalive link']}",
    "pkl_vrf": "{'description': ['VRF used for peer keepalive link'], 'default': 'management'}",
    ...
    "role_priority": "{'description': ['Role priority for device. Remember lower is better.']}",
    "state": "{'description': ['Manages desired state of the resource'], 'required': True, 'choices': ['present', 'absent']}",
    "system_priority": "{'description': ['System priority device.  Remember they must match between peers.']}",
}
```
