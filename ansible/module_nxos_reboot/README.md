# Ansible module: ansible.module_nxos_reboot
...
``` json
{
    "confirm": "{'description': ["Safeguard boolean. Set to true if you're sure you want to reboot."], 'required': False, 'default': False}",
