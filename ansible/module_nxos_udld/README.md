# Ansible module: ansible.module_nxos_udld
...
``` json
{
    "aggressive": "{'description': ['Toggles aggressive mode.'], 'choices': ['enabled', 'disabled']}",
    "msg_time": "{'description': ["Message time in seconds for UDLD packets or keyword 'default'."]}",
    ...
    "reset": "{'description': ["Ability to reset all ports shut down by UDLD. 'state' parameter cannot be 'absent' when this is present."], 'type': 'bool', 'default': False}",
    "state": "{'description': ["Manage the state of the resource. When set to 'absent', aggressive and msg_time are set to their default values."], 'default': 'present', 'choices': ['present', 'absent']}",
}
```
