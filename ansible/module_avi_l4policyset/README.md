# Ansible module: ansible.module_avi_l4policyset
...
``` json
{
    ...
    "created_by": "{'description': ['Creator name.', 'Field introduced in 17.2.7.']}",
    "description": "{'description': ['Field introduced in 17.2.7.']}",
    "is_internal_policy": "{'description': ['Field introduced in 17.2.7.', 'Default value when not specified in API or module is interpreted by Avi Controller as False.'], 'type': 'bool'}",
    "l4_connection_policy": "{'description': ['Policy to apply when a new transport connection is setup.', 'Field introduced in 17.2.7.']}",
    "name": "{'description': ['Name of the l4 policy set.', 'Field introduced in 17.2.7.'], 'required': True}",
    ...
    "tenant_ref": "{'description': ['It is a reference to an object of type tenant.', 'Field introduced in 17.2.7.']}",
    ...
    "uuid": "{'description': ['Id of the l4 policy set.', 'Field introduced in 17.2.7.']}",
}
```
