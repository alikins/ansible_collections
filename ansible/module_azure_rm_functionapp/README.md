# Ansible module: ansible.module_azure_rm_functionapp
...
``` json
{
    ...
    "app_settings": "{'description': ['Dictionary containing application settings']}",
    ...
    "name": "{'description': ['Name of the Azure Function App'], 'required': True}",
    ...
    "resource_group": "{'description': ['Name of resource group'], 'required': True, 'aliases': ['resource_group_name']}",
    "secret": "{'description': ['Azure client secret. Use when authenticating with a Service Principal.']}",
    "state": "{'description': ["Assert the state of the Function App. Use 'present' to create or update a Function App and 'absent' to delete."], 'default': 'present', 'choices': ['absent', 'present']}",
    "storage_account": "{'description': ['Name of the storage account to use.'], 'required': True, 'aliases': ['storage', 'storage_account_name']}",
