# Ansible module: ansible.module_aci_tenant_span_src_group_to_dst_group
...
``` json
{
    ...
    "description": "{'description': ['The description for Span source group to destination group binding.'], 'aliases': ['descr']}",
    ...
    "src_group": "{'description': ['The name of the Span source group.']}",
