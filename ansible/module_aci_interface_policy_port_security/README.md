# Ansible module: ansible.module_aci_interface_policy_port_security
...
``` json
{
    ...
    "description": "{'description': ['The description for the contract.'], 'aliases': ['descr']}",
    "host": "{'description': ['IP Address or hostname of APIC resolvable by Ansible control host.'], 'required': True, 'aliases': ['hostname']}",
    "max_end_points": "{'description': ['Maximum number of end points.', 'Accepted values range between C(0) and C(12000).', 'The APIC defaults to C(0) when unset during creation.'], 'type': 'int'}",
    ...
    "port_security": "{'description': ['The name of the port security.'], 'required': True, 'aliases': ['name']}",
