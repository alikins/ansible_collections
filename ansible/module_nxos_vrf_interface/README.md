# Ansible module: ansible.module_nxos_vrf_interface
...
``` json
{
    "interface": "{'description': ['Full name of interface to be managed, i.e. Ethernet1/1.'], 'required': True}",
    ...
    "state": "{'description': ['Manages desired state of the resource.'], 'required': False, 'default': 'present', 'choices': ['present', 'absent']}",
    "vrf": "{'description': ['Name of VRF to be managed.'], 'required': True}",
}
```
