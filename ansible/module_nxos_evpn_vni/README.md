# Ansible module: ansible.module_nxos_evpn_vni
...
``` json
{
    ...
    "route_distinguisher": "{'description': ['The VPN Route Distinguisher (RD). The RD is combined with the IPv4 or IPv6 prefix learned by the PE router to create a globally unique address.'], 'required': True}",
    "route_target_both": "{'description': ['Enables/Disables route-target settings for both import and export target communities using a single property.']}",
    "route_target_export": "{'description': ["Sets the route-target 'export' extended communities."]}",
    "route_target_import": "{'description': ["Sets the route-target 'import' extended communities."]}",
    ...
    "vni": "{'description': ['The EVPN VXLAN Network Identifier.'], 'required': True}",
}
```
