# Ansible module: ansible.module_slxos_config
...
``` json
{
    ...
    "multiline_delimiter": "{'description': ['This argument is used when pushing a multiline configuration element to the SLX-OS device.  It specifies the character to use as the delimiting character.  This only applies to the configuration action.'], 'default': '@'}",
