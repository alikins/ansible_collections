# Ansible module: ansible.module_avi_microservicegroup
...
``` json
{
    ...
    "name": "{'description': ['Name of the microservice group.'], 'required': True}",
    ...
    "service_refs": "{'description': ['Configure microservice(es).', 'It is a reference to an object of type microservice.']}",
    ...
    "uuid": "{'description': ['Uuid of the microservice group.']}",
}
```
