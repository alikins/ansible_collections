# Ansible module: ansible.module_aci_bd_to_l3out
...
``` json
{
    "bd": "{'description': ['The name of the Bridge Domain.'], 'aliases': ['bd_name', 'bridge_domain']}",
    ...
    "l3out": "{'description': ['The name of the l3out to associate with th Bridge Domain.']}",
