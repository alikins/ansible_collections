# Ansible module: ansible.module_ovirt_nic_facts
...
``` json
{
    ...
    "name": "{'description': ['Name of the NIC, can be used as glob expression.']}",
    ...
    "vm": "{'description': ['Name of the VM where NIC is attached.'], 'required': True}",
}
```
